...
function getTransitionTimingFunctionStyle(
  isOpen,
  openTimingFunction,
  closeTimingFunction
) {
  ...
  var handleCollapsibleTransitionEnd = function($$event) {
    ...
    if (match) {
      ...
      if (match$1.style.clientHeight !== 0) {
        match$1.style.height =
          maxHeight !== undefined ? String(maxHeight) + "px" : "auto";
        return /* () */ 0;
      } else {
        return 0;
      }
  ...
  var getCollapsibleProps = function(param) {
    ...
    return /* record */ [
      ...
      /* style : record */ [
        ...
        /* transitionDuration */ getTransitionDurationStyle(
          isOpen,
          openDuration,
          closeDuration
        ),
