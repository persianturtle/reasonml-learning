...
function Collapse(Props) {
  ...
  var match$3 = Props.closeDuration;
  var closeDuration = match$3 !== undefined ? match$3 : duration;
  Props.closeTimingFunction;
  var match$4 = Props.openDuration;
  var openDuration = match$4 !== undefined ? match$4 : duration;
  ...
  var isOpen = getIsOpen(isOpenProp, match$5[0]);
  ...
  React.useEffect((function () {
          ...
          if (isOpen) {
            ...
            var match = collapsibleRef.current;
            if (!(match == null)) {
              match.style.height = getHeight(isOpen, collapsedHeight, maxHeight, contentRef);
            }
            requestAnimationFrame((function (param) {
                    requestAnimationFrame((function (param) {
                            if (isClosing.current) {
